...
class RunInfo(ItemAttribute):
    ...
    def dims(self):
        ...
        dims = (self.scan0.n, self.scan1.n, self.scan2.n, self.scan3.n)
    ...
    def ndim(self):
        ...
        self._ndim = len(
            self.dims
        )  # why is this stored as a property? It is never used
        return self._ndim
    ...
    def indicies(self):
        ...
        """
        self._indicies = (self.scan0.i, self.scan1.i, self.scan2.i, self.scan3.i)
        self._indicies = self._indicies[: self.ndim]
        return tuple(self._indicies)

    @property
    def line_indicies(self):
        self._line_indicies = (self.scan1.i, self.scan2.i, self.scan3.i)
