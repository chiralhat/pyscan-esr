from pyscan_non_soc_version.drivers.instrument_driver import InstrumentDriver
...
class Keithley2260B(InstrumentDriver):
    ...
    def __init__(self, instrument, debug=False):
        ...
        self.max_current_trigger_ampliutde = float(
            self.query("CURR:TRIG? MAX").strip("\n")
        )
        self.min_current_trigger_ampliutde = float(
            self.query("CURR:TRIG? MIN").strip("\n")
        )
        ...
        self.max_current_rising_slew_rate = float(
            self.query("CURR:SLEW:RIS? MAX").strip("\n")
        )
        self.min_current_rising_slew_rate = float(
            self.query("CURR:SLEW:RIS? MIN").strip("\n")
        )

        self.max_current_falling_slew_rate = float(
            self.query("CURR:SLEW:FALL? MAX").strip("\n")
        )
        self.min_current_falling_slew_rate = float(
            self.query("CURR:SLEW:FALL? MIN").strip("\n")
        )
        ...
        self.max_voltage_trigger_ampliutde = float(
            self.query("VOLT:TRIG? MAX").strip("\n")
        )
        self.min_voltage_trigger_ampliutde = float(
            self.query("VOLT:TRIG? MIN").strip("\n")
        )
        ...
        self.max_voltage_rising_slew_rate = float(
            self.query("VOLT:SLEW:RIS? MAX").strip("\n")
        )
        self.min_voltage_rising_slew_rate = float(
            self.query("VOLT:SLEW:RIS? MIN").strip("\n")
        )

        self.max_voltage_falling_slew_rate = float(
            self.query("VOLT:SLEW:FALL? MAX").strip("\n")
        )
        self.min_voltage_falling_slew_rate = float(
            self.query("VOLT:SLEW:FALL? MIN").strip("\n")
        )
        ...
        self.add_device_property(
            {
                ...
                "write_string": "CURR {}",
                "query_string": "CURR?",
                "range": [self.min_current, self.max_current],
                "return_type": float,
            }
        )
        ...
        self.add_device_property(
            {
                ...
                "range": [
                    self.min_current_trigger_ampliutde,
        ...
        self.add_device_property(
            {
                ...
                "range": [self.min_over_current_level, self.max_over_current_level],
                "return_type": float,
            }
        )
        ...
        self.add_device_property(
            {
                ...
                "range": [
                    self.min_current_rising_slew_rate,
        ...
        self.add_device_property(
            {
                ...
                "range": [
                    self.min_current_falling_slew_rate,
        ...
        self.add_device_property(
            {
                ...
                "write_string": "RES {}",
                "query_string": "RES?",
                "range": [self.min_resistance, self.max_resistance],
                "return_type": float,
            }
        )
        ...
        self.add_device_property(
            {
                ...
                "write_string": "VOLT {}",
                "query_string": "VOLT?",
                "range": [self.min_voltage, self.max_voltage],
                "return_type": float,
            }
        )
        ...
        self.add_device_property(
            {
                ...
                "range": [
                    self.min_voltage_trigger_ampliutde,
        ...
        self.add_device_property(
            {
                ...
                "range": [self.min_over_voltage_level, self.max_over_voltage_level],
                "return_type": float,
            }
        )
        ...
        self.add_device_property(
            {
                ...
                "range": [
                    self.min_voltage_rising_slew_rate,
        ...
        self.add_device_property(
            {
                ...
                "range": [
                    self.min_voltage_falling_slew_rate,
